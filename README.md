...
- **Reconstruction from a reference:** apply_vcf_to_busco.py (VCF SNPs), apply_consensus_to_busco.py (consensus FASTAs), [vcf2phylip](https://github.com/edgardomortiz/vcf2phylip)
...
Full documentation is available in the [Wiki](https://github.com/tomarovsky/BuscoClade/wiki)

- [Usage](https://github.com/tomarovsky/BuscoClade/wiki/Usage) — input preparation, configuration, running the pipeline
- [Configuration](https://github.com/tomarovsky/BuscoClade/wiki/Configuration) — all config parameters with defaults and descriptions
- [Apptainer](https://github.com/tomarovsky/BuscoClade/wiki/Apptainer) — running BuscoClade via pre-built Apptainer container
- [Advanced Usage](https://github.com/tomarovsky/BuscoClade/wiki/Advanced-Usage) — starting from existing BUSCO results, gap-aware AltRef insertion
