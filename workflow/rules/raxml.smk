if config["raxml"]:
    ...
    rule raxml_tree:
        ...
        output:
            bestTree=raxml_dir_path / f"{fasta_dna_filename}.raxml.bestTree",
            log=raxml_dir_path / f"{fasta_dna_filename}.raxml.log",
            rba=raxml_dir_path / f"{fasta_dna_filename}.raxml.rba",
            treefile=raxml_dir_path / f"{fasta_dna_filename}.raxml.treefile",
        params:
            support=raxml_dir_path / f"{fasta_dna_filename}.raxml.support",
